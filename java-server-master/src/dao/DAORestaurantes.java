...
public class DAORestaurantes {
	...
	public ArrayList<Restaurante> darRestaurantes() throws SQLException, Exception {
		...
		while (rs.next()) {
			...
			restaurantes.add(new Restaurante(nombre, tipo, id_administrador));
		}
		return restaurantes;
	}
	...
	public Restaurante buscarRestaurantePorNombre(String name) throws SQLException, Exception {
		Restaurante restaurante = new Restaurante("","",0);
		...
		if(rs.next()) {
			...
			String tipo = rs.getString("TIPO");
			Integer id_administrador = rs.getInt("ID_ADMINISTRADOR");
			restaurante = new Restaurante(nombre, tipo, id_administrador);
		}
	...
	public void addRestaurante(Restaurante restaurante) throws SQLException, Exception {
		...
		String sql = "INSERT INTO RESTAURANTE (NOMBRE,TIPO, ID_ADMINISTRADOR  ) VALUES ('";
